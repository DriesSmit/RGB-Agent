...
def make_analyzer(
    ...
    model_spec = _resolve_analyzer_model(model)
    oc_model = model_spec.oc_model
    ...
    config = {
        "model": oc_model,
        "provider": model_spec.provider_config,
    ...
    def hook(log_path: Path, action_num: int, retry_nudge: str = "") -> Optional[str]:
        ...
        try:
            ...
            if fast or model_spec.fast_by_default:
