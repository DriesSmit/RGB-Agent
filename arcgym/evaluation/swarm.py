...
Usage:
    ...
    arcgym-swarm --env-source re_arc --game taps
"""
...
from arcgym.environments import ArcAgi3Env, ReArcEnv
...
def _resolve_re_arc_games(args: argparse.Namespace) -> list[str]:
    ...
    if args.game:
        ...
        raise ValueError("No games to run. Provide --game (e.g. taps) or --suite.")
    ...
    if unknown:
        raise ValueError(
            ...
            "Use --game taps, --game memory-0001, or another id from re_arc.EnvSampler.list_game_ids()."
        )
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run ARC swarm evaluation.")
    ...
    parser.add_argument("--game", "-g",
                        help="Comma-separated game IDs (e.g. ls20-cb3b57cc,ft09-9ab2447a,taps).")
